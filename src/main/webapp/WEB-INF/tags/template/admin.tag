...
<nav class="navbar navbar-default">
  <div class="container-fluid">
    <div class="navbar-header">
      ...
      <a class="navbar-brand" href="<c:url value='/airport'/>">CSV Aiports</a>
    </div>
      ...
      <ul class="nav navbar-nav">
        <li class="dropdown">
          ...
          <ul class="dropdown-menu">
            <li><a href="<c:url value='/airport/query'/>"><span class="glyphicon glyphicon-search"></span> Query</a></li>
            <li><a href="<c:url value='/airport/reports'/>"><span class="glyphicon glyphicon-print"></span> Reports</a></li>
          </ul>
        </li>
      </ul>
